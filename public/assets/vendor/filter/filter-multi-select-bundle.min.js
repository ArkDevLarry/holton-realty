(function ($) {
  ...
  var FilterMultiSelect = (function () {
    function FilterMultiSelect(selectTarget, args) {
      ...
      this.selectionCounter.style.position = "absolute"
      this.selectionCounter.style.right = "15px"
      // this.selectionCounter.setAttribute("hidden", !restrictSelection);
    ...
    FilterMultiSelect.prototype.update = function () {
      ...
      (this.maxNumSelectedItems > 1) ? this.updateSelectionCounter() : null
    };
    ...
    FilterMultiSelect.prototype.updateSelectionCounter = function () {
      this.selectionCounter.textContent =
        this.numSelectedItems + "/" + (this.maxNumSelectedItems-1);
    };
